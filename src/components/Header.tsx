...
import { Phone, MessageCircle, GraduationCap, Sparkles, BookOpen, Calculator, FileText, Globe, HelpCircle, Briefcase, BookMarked, Clock, Building, Newspaper, Bell, CalendarDays, FileDown, Menu, X, Search, ChevronRight, ChevronLeft, Printer, Keyboard, Languages } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  const navItems = [
    ...
    { id: 'about-desk', label: 'About Educare (Website Overview)', icon: Sparkles, color: 'text-amber-700', activeBg: 'bg-emerald-900', badge: 'Official Description', badgeColor: 'bg-amber-400 text-slate-950 font-black', category: 'Portals & Information', desc: 'Official Mission: Your Guide to a Brighter Future! Admissions, career planning, scholarships & student guidance' },
    ...
    { id: 'typing-test', label: 'Typing Speed Test & Notes', icon: Keyboard, color: 'text-amber-700', activeBg: 'bg-amber-500 text-slate-950', badge: 'PPSC & Fast Typing', badgeColor: 'bg-amber-100 text-amber-950 border-amber-300 font-black', category: 'Solvers & Calculators', desc: 'Practice WPM typing tests for PPSC, DEO & Clerk jobs with touch-typing notes & tips' },
    { id: 'spoken-english', label: 'Spoken English & Grammar (Instructor Nusrat Waqar)', icon: Languages, color: 'text-emerald-700', activeBg: 'bg-emerald-950', badge: 'Instructor Nusrat Waqar', badgeColor: 'bg-amber-400 text-slate-950 font-black', category: 'Solvers & Calculators', desc: 'Spoken lessons, audio pronunciation, instructor notes, grammar rules & voice practice arena' },
